          ...
          <div className="bg-white rounded-2xl w-[95%] md:w-full max-w-lg shadow-2xl animate-popIn flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-start justify-between p-6 border-b border-gray-100 bg-gradient-to-r from-blue-600 to-blue-400 rounded-t-2xl">
              <div className="flex items-start gap-3 flex-1 min-w-0">
                <NotebookPen className="w-6 h-6 text-white flex-shrink-0 mt-0.5" />
                <div className="min-w-0">
                  <h3 className="text-xl font-bold text-white leading-snug">{selectedPublishedQuiz.title}</h3>
                  <p className="text-blue-100 text-sm mt-0.5">Published Quiz</p>
                </div>
              </div>
              <button onClick={() => setSelectedPublishedQuiz(null)} className="ml-3 hover:bg-white/20 rounded-lg p-1.5 transition text-white flex-shrink-0">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-blue-50 rounded-2xl p-4 border border-blue-100">
                  <p className="text-xs uppercase font-bold text-blue-400 tracking-widest mb-3">Quiz Stats</p>
                  <div className="flex items-center gap-4">
                    <div>
                      <p className="text-3xl font-black text-slate-800 leading-none">{selectedPublishedQuiz.questionCount}</p>
                      <p className="text-xs text-slate-500 font-semibold mt-1 uppercase tracking-wide">Questions</p>
                    </div>
                    <div className="w-px h-10 bg-blue-200" />
                    <div>
                      <p className="text-3xl font-black text-slate-800 leading-none">{selectedPublishedQuiz.totalPoints}</p>
                      <p className="text-xs text-slate-500 font-semibold mt-1 uppercase tracking-wide">Points</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                  <p className="text-xs uppercase font-bold text-slate-400 tracking-widest mb-3">Timeline</p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-slate-400 flex-shrink-0" />
                      <div>
                        <p className="text-[10px] text-slate-400 uppercase font-semibold">Created</p>
                        <p className="text-sm font-bold text-slate-700">{selectedPublishedQuiz.createdAt?.seconds ? new Date(selectedPublishedQuiz.createdAt.seconds * 1000).toLocaleDateString("en-PH") : "N/A"}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-slate-700">{selectedPublishedQuiz.updatedAt?.seconds ? new Date(selectedPublishedQuiz.updatedAt.seconds * 1000).toLocaleDateString("en-PH") : "N/A"}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {selectedPublishedQuiz.questions && selectedPublishedQuiz.questions.length > 0 && (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white rounded-2xl p-4 border-2 border-slate-100 shadow-sm">
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-widest mb-3">Question Types</p>
                    <div className="space-y-2.5">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                          <div className="w-2 h-2 rounded-full bg-blue-500" />Multiple Choice
                        </span>
                        <span className="text-sm font-black text-slate-800 bg-slate-100 px-2.5 py-1 rounded-lg">
                          {selectedPublishedQuiz.questions.filter(q => q.type === 'multiple_choice').length}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                          <div className="w-2 h-2 rounded-full bg-purple-500" />True/False
                        </span>
                        <span className="text-sm font-black text-slate-800 bg-slate-100 px-2.5 py-1 rounded-lg">
                          {selectedPublishedQuiz.questions.filter(q => q.type === 'true_false').length}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                  ...
                  {/* Difficulty */}
                  <div className="bg-white rounded-2xl p-4 border-2 border-slate-100 shadow-sm">
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-widest mb-3">Difficulty</p>
                    <div className="space-y-2.5">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                          <div className="w-2 h-2 rounded-full bg-emerald-500" />Easy
                        </span>
                        <span className="text-sm font-black text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg">
                          {selectedPublishedQuiz.questions.filter(q => !q.difficulty || q.difficulty === 'easy').length}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                        ...
                        <span className="text-sm font-black text-amber-700 bg-amber-50 px-2.5 py-1 rounded-lg">
                          {selectedPublishedQuiz.questions.filter(q => q.difficulty === 'average').length}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-slate-700 flex items-center gap-2 font-medium">
                          <div className="w-2 h-2 rounded-full bg-rose-500" />Difficult
                        </span>
                        <span className="text-sm font-black text-rose-700 bg-rose-50 px-2.5 py-1 rounded-lg">
                          {selectedPublishedQuiz.questions.filter(q => q.difficulty === 'difficult').length}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              {selectedPublishedQuiz.classificationStats && (
                <div className="bg-indigo-50 rounded-2xl p-4 border border-indigo-100">
                  <p className="text-xs uppercase font-bold text-indigo-400 tracking-widest mb-3 flex items-center gap-2">
                    <Brain className="w-4 h-4" /> Bloom's Taxonomy
                  </p>
                  <div className="flex gap-3">
                    <div className="flex-1 bg-white border-2 border-purple-100 shadow-sm rounded-xl p-3 flex items-center justify-between">
                      <span className="text-sm font-black text-purple-700 tracking-wide">HOTS</span>
                      <div className="flex items-center gap-1.5">
                        <span className="text-lg font-black text-purple-700">{selectedPublishedQuiz.classificationStats.hots_count}</span>
                        <span className="text-xs font-semibold text-purple-400">({selectedPublishedQuiz.classificationStats.hots_percentage}%)</span>
                      </div>
                    </div>
                    <div className="flex-1 bg-white border-2 border-blue-100 shadow-sm rounded-xl p-3 flex items-center justify-between">
                      <span className="text-sm font-black text-blue-700 tracking-wide">LOTS</span>
                      <div className="flex items-center gap-1.5">
                        <span className="text-lg font-black text-blue-700">{selectedPublishedQuiz.classificationStats.lots_count}</span>
                        <span className="text-xs font-semibold text-blue-400">({selectedPublishedQuiz.classificationStats.lots_percentage}%)</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
                  ...
                  className="bg-white border-2 text-blue-600 hover:bg-blue-50 border-blue-200 font-bold rounded-xl px-4 py-3 flex items-center justify-center gap-2 text-sm transition-all shadow-sm"
                >
                ...
                <button
                  ...
                  className="bg-blue-600 text-white hover:bg-blue-700 font-bold rounded-xl px-4 py-3 flex items-center justify-center gap-2 text-sm shadow-sm transition-all"
                >
                ...
                <button
                  ...
                  className="col-span-2 bg-rose-50 border-2 border-rose-200 text-rose-600 hover:bg-rose-100 px-4 py-3 rounded-xl transition-all flex items-center justify-center gap-2 text-sm font-bold shadow-sm"
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              value={q.points}
                              onChange={(e) =>
                                updateManualQuestion(qIndex, "points", parseInt(e.target.value) || 1)
                              }
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                updateManualQuestion(qIndex, "bloom_classification", e.target.value)
                              }
                              className="w-full px-3 py-2 border rounded-lg"
                            >
                          ...
                          <div>
                            ...
                            <select
                              value={q.cognitive_level || "remembering"}
                              onChange={(e) =>
                                updateManualQuestion(qIndex, "cognitive_level", e.target.value)
                              }
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                updateManualQuestion(qIndex, "difficulty", e.target.value)
                              }
                              className="w-full px-3 py-2 border rounded-lg"
                            >
      ...
      {/* Preview Modal */}
      {
        mounted && showPreviewModal && generatedQuiz && createPortal(
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-2 md:p-4 font-Poppins animate-fadeIn">
            <div className="bg-white rounded-2xl w-[95%] md:w-full max-w-4xl max-h-[95vh] md:max-h-[90vh] flex flex-col animate-slideUp shadow-2xl">
              {/* Header */}
              <div className="flex justify-between items-center p-4 md:p-6 border-b bg-gradient-to-r from-blue-600 to-blue-400 text-white rounded-t-2xl">
              ...
              {/* Question Type Tabs */}
              <div className="px-4 py-4 md:px-6 md:py-6 bg-gray-50 border-b flex flex-col gap-4">
                    ...
                    return (
                      <div className="text-center py-12 flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-400 text-sm mt-1 max-w-xs mx-auto">
                          This AI generated quiz has no questions in this category.
                        </p>
                      </div>
                    );
                  }
                              ...
                              <>
                                <div className="flex items-start gap-4 mb-3">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[17px] font-Poppins text-justify font-medium text-gray-800 leading-relaxed mt-3 mb-1">
                                      {q.question}
                                    </p>
                                  </div>
